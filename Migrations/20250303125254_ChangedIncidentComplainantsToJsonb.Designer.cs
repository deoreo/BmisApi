...
namespace BmisApi.Migrations
{
    ...
    [Migration("20250303125254_ChangedIncidentComplainantsToJsonb")]
    partial class ChangedIncidentComplainantsToJsonb
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BmisApi.Models.Incident", b =>
                {
                    ...
                    b.Property<List<ComplainantInfo>>("Complainants")
                        .IsRequired()
                        .HasColumnType("jsonb");
