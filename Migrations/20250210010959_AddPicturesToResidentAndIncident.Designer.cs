...
namespace BmisApi.Migrations
{
    ...
    [Migration("20250210010959_AddPicturesToResidentAndIncident")]
    partial class AddPicturesToResidentAndIncident
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "blotter_status", new[] { "first_confrontation", "second_confrontation", "third_confrontation", "settled", "justice" });
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "sex", new[] { "prefer_not_to_say", "male", "female" });
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "vawc_status", new[] { "settled", "unsettled" });
